...
public class TargetX : MonoBehaviour
{
    ...
    public AudioClip comidaSound;
    public AudioClip calaveraSound;
    ...
    private void OnMouseDown()
    {
        ...
        {
            // Sonido dependiendo si es buena o mala
            if (gameObject.CompareTag("Bad"))
            {
                audioSource.PlayOneShot(calaveraSound);
            }
            else
            {
                audioSource.PlayOneShot(comidaSound);
            }
            Destroy(gameObject);
